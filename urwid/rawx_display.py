...
class Screen(BaseScreen, RealTerminal):
    def __init__(self, input=sys.stdin, output=sys.stdout):
        ...
        #todo fcntl.fcntl(self._resize_pipe_rd, fcntl.F_SETFL, os.O_NONBLOCK)
    ...
    def signal_init(self):
        ...
        #todo
        ''''''
        signal.signal(signalx.SIGWINCH, self._sigwinch_handler)
        signal.signal(signalx.SIGCONT, self._sigcont_handler)
        ''''''
    ...
    def signal_restore(self):
        ...
        #todo
        ''''''''
        #signal.signal(signalx.SIGCONT, signalx.SIG_DFL)
        #signal.signal(signalx.SIGWINCH, signalx.SIG_DFL)
        ''''''
    ...
    def _start_gpm_tracking(self):
        ...
        m = Popen(["/usr/bin/mev","-e","158"], stdin=PIPE, stdout=PIPE,
            close_fds=True)
        #todo fcntl.fcntl(m.stdout.fileno(), fcntl.F_SETFL, os.O_NONBLOCK)
        self.gpm_mev = m
